        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="event-modal-card">
              ...
              <div class="modal-sub-card">
               ...
               <div class="modal-sub-card">
                <h4 class="modal-sub-head">Web URL</h4>
                <p><?php $rslt=$result[0]->event_description; $r=(explode('WebURL',$rslt,2)); if(!empty($r[1])) print_r($r[1]);?></p>
              </div>
              <div class="modal-sub-card">
          ...
          <div class="modal-footer">
           ...
           <!-- <button type="button" class="btn btn-primary">Edit Event</button> -->
            ...
            <a href="<?= base_url()?>organiser/organiser/edit_event/<?=$result[0]->event_id?>">Edit Event</a> &nbsp 
            <a href="<?= base_url()?>organiser/organiser/delete_awaiting_event/<?=$result[0]->event_id?>">Delete Event</a>
          </div>
        </div>
      </div>
